...
`,buildMenuBarThrobber=themeVariables=>styled_components_browser_esm.iv`
  ...
  background-image: ${({image,isAnimated})=>image??(isAnimated?`url('${throbber_active_namespaceObject}')`:`url('${throbber_passive_namespaceObject}')`)};
...
//# sourceMappingURL=main.5fecea2f.iframe.bundle.js.map