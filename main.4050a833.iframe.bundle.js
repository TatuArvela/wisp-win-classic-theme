(globalThis.webpackChunkwisp_win_classic_theme=globalThis.webpackChunkwisp_win_classic_theme||[]).push([[179],{"./.storybook/preview.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{default:()=>_storybook_preview});var index_esm=__webpack_require__("./node_modules/@tatuarvela/wisp/dist/index.esm.js"),styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const fontFamily="'Microsoft Sans Serif', sans-serif;",generateBoxShadows=(thickness,topLeftColor,bottomRightColor)=>[[thickness,-thickness,topLeftColor],[-thickness,thickness,bottomRightColor],[-thickness,thickness-1,topLeftColor],[thickness,1-thickness,bottomRightColor],[-thickness,-thickness,topLeftColor],[thickness,thickness,bottomRightColor]].reverse().map((([x,y,color])=>`${x}px ${y}px 0 0 ${color}`)).join(",\n"),generateSharedButtonStyles=themeVariables=>{const activeStyles=styled_components_browser_esm.iv`
  ...
  padding: 2px;
  user-select: none;
`,common_buildControls=themeVariables=>({Button:buildButton(themeVariables)}),buildTaskbar=themeVariables=>styled_components_browser_esm.iv`
  background: ${themeVariables.shade2};
...
`,common_buildWindow=themeVariables=>({WindowElement:buildWindowElement(themeVariables),WindowContent:styled_components_browser_esm.iv`
  box-sizing: border-box;
  display: flex;
  flex-direction: column;
  flex-grow: 1;
