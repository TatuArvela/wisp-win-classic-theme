...
`,buildWindowContent=themeVariables=>styled_components_browser_esm.iv`
  ...
  flex-grow: 1;
  overflow: hidden;
`,controls_buildControls=themeVariables=>({AddressBarElement:styled_components_browser_esm.iv`
  align-items: center;
  box-sizing: border-box;
  display: flex;
  flex-grow: 1;
  font-family: sans-serif;
  font-size: 12px;
`,AddressBarLabel:styled_components_browser_esm.iv`
...
//# sourceMappingURL=main.40ac7c30.iframe.bundle.js.map