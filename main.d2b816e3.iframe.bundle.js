...
`,generateButtonStyles=themeVariables=>{const activeStyles=styled_components_browser_esm.iv`
  ...
  `},left_namespaceObject=__webpack_require__.p+"static/media/left.2b4fbd74.png",right_namespaceObject=__webpack_require__.p+"static/media/right.4bb7ff2a.png",up_namespaceObject=__webpack_require__.p+"static/media/up.93ab41bd.png",scrollableContentView=styled_components_browser_esm.iv`
...
`,ListBoxOption:buildListBoxOption(themeVariables),MenuBar:buildMenuBar(themeVariables),ProgressBar:buildProgressBar(themeVariables),ProgressBarFill:buildProgressBarFill(themeVariables),...controls_buildScrollbars(themeVariables),StatusBar:styled_components_browser_esm.iv`
  bottom: 0;
  box-sizing: border-box;
  display: flex;
  margin-top: auto;
  ...
  width: 100%;
  position: relative;
`,ResizeHandle:buildResizeHandle(themeVariables),StatusBarSection:buildStatusBarSection(themeVariables),TextInputElement:buildTextInputElement(themeVariables),TextareaElement:buildTextareaElement(themeVariables),...controls_buildTimeInput(themeVariables)}),buildTaskbar=themeVariables=>styled_components_browser_esm.iv`
  background: ${themeVariables.shade2};
...
`,buildTaskbarButton=themeVariables=>{const activeStyle=styled_components_browser_esm.iv`
  ...
  top: 0;
  object-fit: cover;
`,elements_buildElements=themeVariables=>({Desktop:buildDesktop(themeVariables),Taskbar:buildTaskbar(themeVariables),TaskbarButton:buildTaskbarButton(themeVariables),VersionInfo:styled_components_browser_esm.iv`
  bottom: 30px;
  color: white;
  font-family: ${fontFamily};
  font-size: 14px;
  ...
  text-align: right;
  user-select: none;
`}),sharedStyle=styled_components_browser_esm.iv`
  box-sizing: border-box;
  position: absolute;
...
`,window_buildWindow=themeVariables=>({WindowElement:buildWindowElement(themeVariables),WindowElementContent:styled_components_browser_esm.iv`
  box-sizing: border-box;
  display: flex;
  flex-direction: column;
  flex-grow: 1;
