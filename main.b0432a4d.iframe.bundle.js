...
`,AddressBarIcon=styled_components_browser_esm.AH`
  ...
  width: 16px;
  image-rendering: pixelated;
`,buildMessageBoxButtonElement=themeVariables=>styled_components_browser_esm.AH`
...
`,MessageBoxContent=styled_components_browser_esm.AH`
  display: flex;
  gap: 16px;
  padding: 12px 12px;
`,MessageBoxIconElement=styled_components_browser_esm.AH`
  height: 32px;
  width: 32px;
  image-rendering: pixelated;
`,MessageBoxText=styled_components_browser_esm.AH`
  display: inline-flex;
  flex-grow: 1;
...
`,controls_buildControls=themeVariables=>({AddressBarElement:styled_components_browser_esm.AH`
  ...
  font-family: sans-serif;
  font-size: 12px;
`,AddressBarIcon,AddressBarInput:buildAddressBarInput(themeVariables),AddressBarInputContainer:buildAddressBarInputContainer(themeVariables),AddressBarLabel:styled_components_browser_esm.AH`
  padding: 1px 4px 0 4px;
`,ButtonElement:buildButtonElement(themeVariables),CheckboxElement:buildCheckboxElement(themeVariables),CheckboxWrapper:buildCheckboxWrapper(),ComboBoxButton:buildComboBoxButton(themeVariables),ComboBoxControl:buildComboBoxControl(themeVariables),ComboBoxInput:buildComboBoxInput(themeVariables),ComboBoxOption:buildComboBoxOption(themeVariables),ComboBoxOptions:buildComboBoxOptions(),Divider:buildDivider(themeVariables),FieldsetElement:buildFieldsetElement(themeVariables),FieldsetLegend:buildFieldsetLegend(themeVariables),Label:buildLabel(themeVariables),ListBoxButton:buildListBoxButton(themeVariables),ListBoxControl:buildListBoxControl(themeVariables),ListBoxOption:buildListBoxOption(themeVariables),ListBoxOptions:styled_components_browser_esm.AH`
  ${buildComboBoxOptions()}
`,ListBoxValue:buildListBoxValue(themeVariables),MenuBarElement:buildMenuBarElement(themeVariables),MenuBarThrobberContainer:buildMenuBarThrobberContainer(themeVariables),MenuBarThrobberIconElement:styled_components_browser_esm.AH`
    height: 22px;
    width: 22px;
  `,MessageBoxButtonElement:buildMessageBoxButtonElement(themeVariables),MessageBoxContent,MessageBoxIconElement,MessageBoxText,ProgressBarElement:buildProgressBarElement(themeVariables),ProgressBarFill:buildProgressBarFill(themeVariables),...controls_buildScrollbars(themeVariables),ResizeHandle:buildResizeHandle(themeVariables),StatusBarElement:styled_components_browser_esm.AH`
  bottom: 0;
  box-sizing: border-box;
  display: flex;
  margin-top: auto;
  ...
  width: 100%;
  position: relative;
`,StatusBarSectionElement:buildStatusBarSectionElement(themeVariables),TextInputElement:buildTextInputElement(themeVariables),TextareaElement:buildTextareaElement(themeVariables),...controls_buildTimeInput(themeVariables),ToolbarButtonElement:buildToolbarButtonElement(themeVariables),ToolbarElement:buildToolbarElement(themeVariables),Well:buildWell(themeVariables),WindowContent:buildWindowContent(themeVariables)}),buildTaskbarElement=themeVariables=>styled_components_browser_esm.AH`
  ${cursors_cursor("default")}
  background: ${themeVariables.shade3};
...
`,maximizedStyles=styled_components_browser_esm.AH`
  border-radius: 0;
  height: ${props=>{return`calc(100% - ${(viewportWindowMargins=props.viewportMargins).top+viewportWindowMargins.bottom}px)`;var viewportWindowMargins}} !important;
  left: ${props=>props.viewportMargins.left} !important;
  padding: 0 !important;
  top: ${props=>props.viewportMargins.top} !important;
  width: ${props=>{return`calc(100% - ${(viewportWindowMargins=props.viewportMargins).left+viewportWindowMargins.right}px)`;var viewportWindowMargins}} !important;
