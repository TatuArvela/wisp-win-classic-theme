...
`,generateAccentuatedStyles=themeVariables=>styled_components_browser_esm.iv`
  box-shadow:
    0.5px 0.5px 0 0.5px ${themeVariables.shade4},
    0 0 0 1px ${themeVariables.shade1};
`,generateGroovedStyles=themeVariables=>styled_components_browser_esm.iv`
...
`,generateRecessedStyles=themeVariables=>styled_components_browser_esm.iv`
  box-shadow:
...
`,generateSharedButtonStyles=themeVariables=>{const activeStyles=styled_components_browser_esm.iv`
...
`,buildProgressBarFill=themeVariables=>{const indeterminateStyle=styled_components_browser_esm.iv`
  ...
  `},buildScrollButton=themeVariables=>styled_components_browser_esm.iv`
  ${generateElevatedStyles(themeVariables)}
  height: 20px;
  width: 20px;
...
`,AddressBarInput:buildAddressBarInput(themeVariables),Button:buildButton(themeVariables),CheckboxWrapper:buildCheckboxWrapper(),Checkbox:buildCheckbox(themeVariables),ComboBoxControl:buildComboBoxControl(themeVariables),ComboBoxInput:styled_components_browser_esm.iv`
  ...
  border: none;
  flex-grow: 1;
`,ComboBoxButton:buildComboBoxButton(themeVariables),ComboBoxOptions:buildComboBoxOptions(),ComboBoxOption:buildComboBoxOption(themeVariables),Divider:buildDivider(themeVariables),Fieldset:buildFieldset(themeVariables),FieldsetLegend:buildFieldsetLegend(themeVariables),Label:styled_components_browser_esm.iv`
  color: ${props=>props.disabled?"gray":"black"};
  font-size: 12px;
  font-family: sans-serif;
  margin: 0;
`,ListBoxButton:buildListBoxButton(themeVariables),ListBoxOptions:styled_components_browser_esm.iv`
  ${buildComboBoxOptions()}
`,ListBoxOption:buildListBoxOption(themeVariables),MenuBar:buildMenuBar(themeVariables),ProgressBar:buildProgressBar(themeVariables),ProgressBarFill:buildProgressBarFill(themeVariables),ScrollUpButton:buildScrollButton(themeVariables),ScrollDownButton:buildScrollButton(themeVariables),ScrollRightButton:buildScrollButton(themeVariables),ScrollLeftButton:buildScrollButton(themeVariables),ScrollbarVerticalTrack:buildScrollbarVerticalTrack(themeVariables),ScrollbarVerticalThumb:buildScrollbarVerticalThumb(themeVariables),ScrollbarHorizontalTrack:buildScrollbarHorizontalTrack(themeVariables),ScrollbarHorizontalThumb:buildScrollbarHorizontalThumb(themeVariables)}),buildTaskbar=themeVariables=>styled_components_browser_esm.iv`
  background: ${themeVariables.shade2};
...
//# sourceMappingURL=main.c31d5122.iframe.bundle.js.map